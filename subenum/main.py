...
def doctor(
    ...
    console.print("  [green]✓[/] Interesting target scoring + probe enrichment (auto)")
    console.print("  [green]✓[/] Security headers audit — HSTS, CSP, CORS, cookies (auto)")
    console.print("  [green]✓[/] Response deduplication / soft-404 filtering (auto)")
    console.print("  [green]✓[/] CNAME takeover detection (auto)")
    console.print("  [green]✓[/] DNS brute-force (--bruteforce --wordlist)")
    console.print("  [green]✓[/] Permutation/mutation engine — version & number variants (--permutate)")
    console.print("  [green]✓[/] Recursive sub-zone enumeration (--recursive)")
    console.print("  [green]✓[/] Port scanning — 35+ high-value ports (--scan-ports)")
    console.print("  [green]✓[/] JavaScript endpoint/secret/subdomain extraction (--js)")
    console.print("  [green]✓[/] Shodan IP enrichment — ports, banners, CVEs (--shodan)")
    console.print("  [green]✓[/] Nuclei auto-trigger with live progress (--nuclei)")
    console.print("  [green]✓[/] Resume after connection drop (--resume)")
    console.print("  [green]✓[/] Diff against previous scan (--diff)")
    console.print("  [green]✓[/] Webhook notifications — Discord/Slack (WEBHOOK_URL)")
    console.print("  [green]✓[/] Wordlist management — stats/merge/generate (wordlist subcommand)")
